        ...
        public static List<Character> GetCharacters()
        {
            return new List<Character>
            {
                new Character
                {
                    ...
                    Description = "Powerful underworld figure with territory disputes. Main rival of Hal Sapone",
                ...
                new Character
                {
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was by the side door nursing a twisted ankle when I heard the shot.\n• If asked, you can CORROBORATE: Tommy 'Four Guns' Beagle / Beanie O'Dannon\n  • If asked about Tommy 'Four Guns' Beagle, say exactly: 'I saw Four Guns at the office door when the blast went off.'\n  • If asked about Beanie O'Dannon, say exactly: 'I know Beanie O'Dannon was yelling at Sam when the shot rang out—loud as a parade.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Hershey Bar\nTRUE STORY REVEAL:\nI was near the side door moving an empty crate out, and I had turned my ankle on the step earlier—Tommy was laughing at me. When the bang echoed, I was nowhere near that hallway.\nFOLLOWED BY: Marlie Maplin",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Hershey makes noise...\nCHAOS ACTION: \nSpin with airplane arms, 'crash land' beside someone, and accuse them of sabotaging your flight."
                },
                ...
                new Character
                {
                    ...
                    Description = "Former Broadway performer seeking new opportunities",
                    ...
                    Secrets = "You've been blackmailing theater producers and wealthy patrons",
                    Costume = "Sparkling feathered dress with finger waves hairstyle, glittery eye makeup and bold blush",
                    Round1Content = "INTERACTIONS & REVEAL CLUES:\n• Go to Jazzy Fringe and say: 'Jazzy—check out my new dance moves later. Meet me by the stage and I'll show you the full razzle-dazzle!'\n• Go to Kara Low and say: 'Kara—if Hal gives you the squeeze, tell him he's gotta deal with me.'\n• Go to Harry Looper and say: 'Harry, Hal's thrown a wrench in both our careers. I'm about fed up with his back-stage meddling. You and me outta do somethin' about it!'\n\nCONCEALED SECRETS:\n• Hal once canceled your show when you rejected him; you still want payback.\n• You're staging a little practice routine near the stage later—perfect for being seen.",
                    Round2AContent = "PART A – PRE-MURDER:\n• Go to Mona Crawfish and say: 'I think Chuck Limberger is a dirty liar! He's been spreading rumors about my Uncle, saying my Uncle is corrupt!'\n• Go to Hershey Bar and say: 'This place might make a girl nervous! Would you play a brave tune for us girls tonight? To help keep us calm!'",
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was near the stage tapping a rhythm to the music when the gunshot boomed.\n• If asked, you can CORROBORATE: Hershey Bar / Jazzy Fringe\n  • If asked about Hershey Bar, say exactly: 'I know Hershey Bar was tuning up his sax when the shot thundered.'\n  • If asked about Jazzy Fringe, say exactly: 'I know Jazzy Fringe was dancing on the floor when the shot rang out.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Haddie Drinx\nTRUE STORY REVEAL:\nI was up by the stage practicing a soft-shoe routine, trying to impress anyone with a pulse. Jazzy and Hershey told me to quit tapping out the beat right before the bang. I may be desperate for the spotlight, but murder ain't my kind of show.\nFOLLOWED BY: Hershey Bar",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Haddie drops to the ground OR anyone falls...\nCHAOS ACTION: \nLeap up shouting 'EMERGENCY INTERMISSION!' Strike a pose and accuse the nearest person of ruining your big moment."
                },
                ...
                new Character
                {
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was 'checking medical supplies' at the moment when I heard the gun shot. I fix people, I don't break them!\n• If asked, you can CORROBORATE: Marlie Maplin\n  • If asked about Marlie Maplin, say exactly: 'I know Marlie Maplin was in the ladies' room fussing with makeup and such when the gun fired.'",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER: After confessing, point to any player and say: 'Pick a number between 1 and 10. Shout it out loud!' \nCHAOS ACTION: \nIf the number is EVEN, then you shoot them (finger-gun) and tell them to fall to the floor.\nIf the number is ODD, then yell, 'I CAN'T GO TO JAIL!' and shoot yourself in the head and fall to the floor."
                },
                ...
                new Character
                {
                    ...
                    Name = "Haddie Drinx",
                    Occupation = "Waitress",
                    Description = "Hardworking employee who sees everything",
                    ...
                    Goals = "To earn enough money to open your own restaurant",
                    Secrets = "You've been watering down drinks and pocketing the difference",
                ...
                new Character
                {
                    ...
                    Description = "Powerful underworld figure with territory disputes. Main rival of Beanie O'Dannon",
                    ...
                    Goals = "To eliminate your rivals and control all illegal activities in the city",
                    Secrets = "You're planning to have your rival Beanie O'Dannon eliminated tonight",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nWhen Beanie yells, 'IT'S AN INSIDE JOB!' or when Tommy says 'RAT IN THE ROOM!'...\nCHAOS ACTION:\nStand up and yell 'I'LL HAUNT ALL YOU DIRTY ROTTEN SCOUNDRELS!' and then drop dead on the floor."
                },
                ...
                new Character
                {
                    ...
                    Occupation = "Enforcer",
                    Description = "Charming muscle who uses charm before violence. Beanie O'Dannon's right hand man",
                    Background = "Smooth-talking charmer with dangerous confidence.",
                    PersonalityTraits = "Charismatic, dangerous, overconfident",
                    Goals = "To become a crime boss in your own right",
                    Secrets = "You've been embezzling money from your employer's collections",
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was at the bar jawing with Beanie when I heard the loud noise.\n• If asked, you can CORROBORATE: Beanie O'Dannon / Tommy 'Four Guns' Beagle\n  • If asked about Beanie O'Dannon, say exactly: 'I know Beanie O'Dannon was at the bar yelling at Sam when the big bang occurred—loud as a parade.'\n  • If asked about Tommy 'Four Guns' Beagle, say exactly: 'I saw Tommy stationed near the office door when the blast went off.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Tommy 'Four Guns' Beagle\nTRUE STORY REVEAL:\nI was locked in a loud argument with Beanie at the bar, the kind where everyone hears every insult. Ruby and Haddie were close enough to wince. I don't do quiet work; I make public problems public.\nFOLLOWED BY: Officer Clyde 'Clipper' Mulligan",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Tommy shouts 'RAT IN THE ROOM'...\nCHAOS ACTION:\n slick your hair back and demand a silent stare-off with him. Tell him: 'The first one to blink is guilty.'"
                },
                ...
                new Character
                {
                    ...
                    Description = "Fellow performer and rival to Zetta Zarbo",
                    ...
                    Secrets = "You've been sabotaging other actors' careers to advance your own",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Wyleen shouts, 'I'VE GOT THE SCOOP!'...\nCHAOS ACTION:\nPerform a dramatic death scene. Then pop up and declare 'I AM THE GREATEST ACTOR EVER!'."
                },
                ...
                new Character
                {
                    ...
                    Description = "Multi-talented performer and local celebrity",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Daisy shouts OR an accusation flies...\nCHAOS ACTION:\nBlast an imaginary sax note, then point at someone and loudly declare they have terrible rhythm."
                },
                ...
                new Character
                {
                    ...
                    Description = "Young performer trying to make her mark",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nWhen anyone 'dies' or drops to the floor...\nCHAOS ACTION:\nShout 'JAZZ ATTACK!' finger-gun two people, then freeze in a 'Charlie's Angels' pose."
                },
                ...
                new Character
                {
                    ...
                    Description = "Star performer who seems to know everyone's secrets",
                    ...
                    Goals = "To gather enough information to blackmail your way to the top",
                    Secrets = "You've been recording private conversations for blackmail purposes",
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was backstage warming up my voice when the explosive sound tore through the club.\n• If asked, you can CORROBORATE: Jazzy Fringe / Zetta Zarbo\n  • If asked about Jazzy Fringe, say exactly: 'I know Jazzy Fringe was on the dance floor mid‐routine when the report echoed down the hallway.'\n  • If asked about Zetta Zarbo, say exactly: 'I know Zetta Zarbo was backstage tearing a paper into bits when the gun sounded.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Mona Crawfish\nTRUE STORY REVEAL:\nI was backstage warming my voice, trying to hit a high note that could shatter glass. Zetta yelled at me to 'keep it down' seconds before the bang. If I'd been in that hallway, he'd have heard me coming.\nFOLLOWED BY: Professor Alistair Finch",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf the person yells out an EVEN number...\nCHAOS ACTION:\nStand up and sing 'Eensy, Weensy Spider'."
                },
                ...
                new Character
                {
                    ...
                    Name = "Lola Glass",
                    Occupation = "Waitress",
                    Description = "Veteran server with connections to regular patrons",
                    ...
                    Goals = "To maintain your position and protect your regulars' secrets",
                    Secrets = "You've been passing information about customers to the police",
                    ...
                    Round2AContent = "PART A – PRE-MURDER:\n• Go to Beanie O'Dannon and say: 'Here's the whisky you ordered.'\n• Go to Ruby 'Red' Callahan and say: 'I saw you slam the register shut when startled. Why so jumpy?'",
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was at the main bar serving drinks when the loud boom sounded, like a gun shot.\n• If asked, you can CORROBORATE: Mona Crawfish / Ruby 'Red' Callahan\n  • If asked about Mona Crawfish, say exactly: 'I saw Mona stretching by the side bar when the gun exploded.'\n  • If asked about Ruby 'Red' Callahan, say exactly: 'I saw Red at the register at the time the shot was fired.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Haddie Drinx\nTRUE STORY REVEAL:\nTruth is, I was working the main bar when that bang rang out—handing out glasses. Ruby and Hershey saw me nearly drop those drinks in surprise. I ain't never seen no one killed let alone actually kill someone.\nFOLLOWED BY: Daisy LaRue",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf anyone screams, drops, faints, or yells 'SHOT!'...\nCHAOS ACTION:\nShriek 'NOT IN MY LOUNGE!' and drop to the ground. If someone else drops too, join them on the floor dramatically."
                },
                ...
                new Character
                {
                    ...
                    Description = "Rising star and potential threat to established actors",
                    ...
                    Secrets = "You've been blackmailing studio executives with compromising photos",
                    Costume = "Satin dress with pearls, wave-set curls, carrying cigarette holder (prop)",
                    Round1Content = "INTERACTIONS & REVEAL CLUES:\n• Go to Dr. Viola Thatch and say: 'Doctor—if I vanish to fix my face later, it's vanity, darlin', pure glitterin' vanity! Certainly not anything dreary like villainy!'\n• Go to Zetta Zarbo and say: 'Zetta—Sapone's been muttering names. If mine comes up, you tell me fast!'\n• Go to 'Handsome Sam' McWarthy and say: 'Tell Beanie, I've been silent my whole film career, but if tonight goes sideways, then I will find my voice!'\n\nCONCEALED SECRETS:\n• Hal threatened to sabotage your next picture unless you 'played nice' at your private meeting.\n• You saw Dr. Thatch slip toward the storage hallway and it struck you as oddly purposeful.",
                    Round2AContent = "PART A – PRE-MURDER:\n• Go to Chuck Limberger and say: 'Keep an eye on Mona Crawfish, she is acting suspicious! Hal's using some dirt to keep Mona in line. He owns her career.'\n• Go to Mona Crawfish and say: 'Hal called me 'replaceable' and laughed. He's got some nerve!'",
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was by the hallway mirror rehearsing a monologue when the gun fired.\n• If asked, you can CORROBORATE: Dr. Viola Thatch\n  • If asked about Dr. Viola Thatch, say exactly: 'I saw the lady doctor moving with purpose right around the time of the loud bang.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Chuck Limberger\nTRUE STORY REVEAL:\nI was in the ladies' room powdering my nose like. Harry was fussing at the hallway mirror near the bathrooms at the time of the murder; he can tell you I never left. My career may be dramatic, but my alibi isn't.\nFOLLOWED BY: Ray Stingray",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Chuck crashes OR anyone hits the floor...\nCHAOS ACTION:\nMime silent-film panic, like you are stuck in a box and any other mime behavior."
                },
                ...
                new Character
                {
                    ...
                    Description = "Local celebrity and party entertainment",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Jazzy finger-guns anyone...\nCHAOS ACTION:\nDo a frantic Charleston, bump one or two people, and blame them for starting it."
                },
                ...
                new Character
                {
                    ...
                    Description = "Federal agent investigating the speakeasy operation",
                    Background = "Commanding lawman with a watchful eye. Your friends call you 'Clipper'",
                    ...
                    Secrets = "You've been taking bribes from multiple criminal organizations",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Sam starts a stare-off...\nCHAOS ACTION:\nBlow a pretend whistle and yell 'CODE 29!' and detain someone for a standing 10-count, like a staggering boxer."
                },
                ...
                new Character
                {
                    ...
                    Occupation = "Inventor",
                    Description = "Eccentric genius who creates gadgets for criminal enterprises",
                    Background = "Eccentric inventor obsessed with puzzles and codes.",
                    PersonalityTraits = "Brilliant, eccentric, socially awkward",
                    Goals = "To perfect your inventions and gain recognition for your genius",
                    Secrets = "You've been creating deadly devices that you're planning to test on real people",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Kara points at anyone...\nCHAOS ACTION:\nWhip out your imaginary lie-detector and announce 'BEEPING MEANS GUILTY!' Walk around the room and scan wildly making random loud Beeping noises."
                },
                ...
                new Character
                {
                    ...
                    Name = "Ray Stingray",
                    Occupation = "Novelist",
                    Description = "Writer researching criminal underworld for his next book",
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was by the office jotting down quotes when the explosive sound shook the building.\n• If asked, you can CORROBORATE: Professor Alistair Finch\n  • If asked about Professor Alistair Finch, say exactly: 'I know Professor Alistair Finch was near his contraption when the gun sounded.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Marlie Maplin\nTRUE STORY REVEAL:\nI was seated with my notebook near the entrance, scribbling a chapter when Hal got what he deserved. The bang startled me so badly I blotted ink across the page—I showed Wyleen and she called it 'evidence.' I write murders; I don't commit them.\nFOLLOWED BY: Wyleen Black",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Marlie acts like a mime OR someone yells 'WHO DID IT'...\nCHAOS ACTION:\nAnnounce 'PLOT TWIST!' and point at two different people as co-conspirators and yell 'YOU and YOU!'."
                },
                ...
                new Character
                {
                    ...
                    Description = "Independent supplier competing with the major crime families",
                    Background = "Sharp-tongued speakeasy owner, fiercely protective.",
                    PersonalityTraits = "Tough, independent, fiercely protective of your territory",
                    Goals = "To build your own criminal empire without being absorbed by the big gangs",
                    Secrets = "You've been poisoning the competition's alcohol supplies",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Zetta faints OR Hal's ghost speaks...\nCHAOS ACTION:\nShout 'EVERYBODY FREEZE!' and point your finger-gun toward the ceiling, declaring martial law."
                },
                ...
                new Character
                {
                    ...
                    Occupation = "Enforcer",
                    Description = "Muscle for hire, loyal to whoever pays best, which for the moment is Hal Sapone",
                    Background = "Hard-edged, loyal right-hand man always on alert.",
                    PersonalityTraits = "Violent, loyal, simple but effective",
                    Goals = "To prove your worth and move up in the criminal hierarchy",
                    Secrets = "You're planning to eliminate your current boss and take over",
                    Costume = "Suspenders with rolled sleeves, slicked back hair, shoulder holster (prop), fake mustache",
                    Round1Content = "INTERACTIONS & REVEAL CLUES:\n• Go to Chuck Limberger and say: 'Chuck—if you're hauling crates tonight, keep them away from the storage hallway. I don't want any surprises.'\n• Go to 'Handsome Sam' McWarthy and say: 'Sam, you and your boys betta' stay outta the storage hallway area. That's Hal Sapone's territory.'\n• Go to Ruby 'Red' Callahan and say: 'Red, your till is light and Hal knows it! Some shady scoundrel's skimming your register—and He don't tolerate swindlers!'\n\nCONCEALED SECRETS:\n• You've seen Hal's payoff ledger—certain names keep popping up, like Dr. Viola Thatch and Zetta Zarbo.\n• Hal hinted he might replace you after tonight; you're hunting for an exit plan, just in case.",
                    Round2AContent = "PART A – PRE-MURDER:\n• Go to Haddie Drinx and say exactly: 'Hal ordered me to stay posted where I can watch the hallway. If anyone asks, you tell 'em that Tommy 'Four Guns' Beagle was stationed by the office door.'\n• Go to 'Handsome Sam' McWarthy and say angrily: 'I heard that Hal may be looking to replace me. Hal's a fink. I've been runnin' his racket longer than any other mug!'",
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was posted by the office door watching the hallway on Hal's orders at the time of the deafening blast. I guess someone coulda' snuck passed my watch since I get distracted sometimes.\n• If asked, you can CORROBORATE: 'Handsome Sam' McWarthy / Chuck Limberger\n  • If asked about 'Handsome Sam' McWarthy, say exactly: 'I know 'Handsome Sam' McWarthy was jawing with Beanie at the bar when I heard the shot.'\n  • If asked about Chuck Limberger, say exactly: 'I know Chuck Limberger was hobbling around by the office door at the time the shot was fired.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Professor Alistair Finch\nTRUE STORY REVEAL:\nI was at my post watching the office door and storage hallway like Hal ordered, watching for trouble and counting footsteps. Chuck will tell you I teased him about his ankle right before the bang. If I'd left my post, Hal would've had my hide—ironically.\nFOLLOWED BY: 'Handsome Sam' McWarthy",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Finch's imaginary gadget 'beeps'...\nCHAOS ACTION:\nFinger-gun the ceiling and shout 'RAT IN THE ROOM!'"
                },
                ...
                new Character
                {
                    ...
                    Description = "Investigative journalist always looking for the next big story",
                    ...
                    Secrets = "You're actually working undercover for federal law enforcement",
                    ...
                    Round2BContent = "PART B – POST-MURDER:\n• Your one-sentence alibi: I was at the entrance grilling Mulligan when the explosive sound tore through the club.\n• If asked, you can CORROBORATE: Professor Alistair Finch / Officer Clyde 'Clipper' Mulligan\n  • If asked about Professor Alistair Finch, say exactly: 'I know Professor Alistair Finch was fussing with that buzzing gadget in the corner when I heard the gun blast.'\n  • If asked about Officer Clyde 'Clipper' Mulligan, say exactly: 'I know Officer Clyde 'Clipper' Mulligan was near the entrance area when the shot was heard.'",
                    Round3AMotiveReveal = "FOLLOW AFTER: Ray Stingray\nTRUE STORY REVEAL:\nI was grilling Officer Mulligan near the entrance about who's been bribing whom. When the bang sounded, he ducked and I nearly swallowed my pencil—he'll confirm it. I wanted Hal's headline, not his head.\nFOLLOWED BY: Harry Looper",
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Ray shouts 'PLOT TWIST'...\nCHAOS ACTION:\nYell 'I'VE GOT THE SCOOP!' and write a new headline in your invisible notebook."
                },
                ...
                new Character
                {
                    ...
                    Name = "Zetta Zarbo",
                    Occupation = "Silent Film Star",
                    Description = "Hollywood glamour queen visiting the speakeasy",
                    ...
                    Round3BChaoticEnding = "CHAOS TRIGGER:\nIf Officer Mulligan detains anyone...\nCHAOS ACTION:\nShriek 'MY CLOSE-UP!' and faint onto the nearest chair."
                }

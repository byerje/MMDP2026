        ...
        public static List<Character> GetCharacters()
        {
            return new List<Character>
            {
                new Character
                {
                    ...
                    Goals = "To destroy Hal Sapone's organization and take over your territory",
                ...
                new Character
                {
                    ...
                    Occupation = "Enforcer",
                    Description = "Charming muscle who uses charm before violence",
                ...
                new Character
                {
                    ...
                    Round1Content = "INTERACTIONS & REVEAL CLUES:\n• Go to Marlie Maplin and say: 'Marlie—if you hear any juicy stories, tell me first. I don't want rumors starting without me.'\n• Go to Mona Crawfish and say: 'You ever notice, Mona, how Hal leans hardest on the people who know how to last the longest? You've been testin' my limits, too.'\n• Go to Beanie O'Dannon and say: 'Beanie, pal—if you see me at the hallway mirror later, that's acting, not sneaking.'\n\nCONCEALED SECRETS:\n• You're desperate for a comeback and you'd sell a scandal to fund a new picture.\n• You keep a prop pistol for auditions. It looks real enough to cause panic if seen.",
                    Round2AContent = "PART A – PRE-MURDER:\n• Go to Chuck Limberger and say: 'Keep an eye on Marlie Maplin, she is acting suspicious! Hal's using some dirt to keep Marlie in line. He owns your career.'\n• Go to Marlie Maplin and say: 'Hal called me 'replaceable' and laughed. You're got some nerve!'",
                ...
                new Character
                {
                    ...
                    Description = "Young performer trying to make your mark",
                ...
                new Character
                {
                    ...
                    Description = "Star performer who knows everyone's secrets",
                ...
                new Character
                {
                    ...
                    Name = "Ray Stingray",
                    Occupation = "Novelist",
                    Description = "Writer researching criminal underworld for your next book",
                    ...
                    Secrets = "You've been planning the perfect murder for your book and considering trying it in real life",
                ...
                new Character
                {
                    ...
                    Occupation = "Enforcer",
                    Description = "Muscle for hire, loyal to whoever pays best",
                    ...
                    Round3AMotiveReveal = "FOLLOW AFTER: Professor Alistair Finch\nTRUE STORY REVEAL:\nI was posted to watch the office door and storage hallway like Hal ordered, watching for trouble and counting footsteps. Chuck will tell you I teased him about your ankle right before the bang. If I'd left my post, Hal would've had my hide—ironically.\nFOLLOWED BY: 'Handsome Sam' McWarthy",
                ...
                new Character
                {
                    ...
                    Round3AMotiveReveal = "FOLLOW AFTER: Ray Stingray\nTRUE STORY REVEAL:\nI was grilling Officer Mulligan near the entrance about who's been bribing whom. When the bang sounded, he ducked and I nearly swallowed my pencil—he'll confirm it, begrudgingly. I wanted Hal's headline, not your heartbeat.\nFOLLOWED BY: Harry Looper",
